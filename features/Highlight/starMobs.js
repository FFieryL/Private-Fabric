...
const mobRenderer = register("renderWorld", () => {
    ...
    if (validPests) {
        ...
        for (let i = 0; i < pests.length; ++i) {
            ...
            RenderUtils.drawFilled(newBox, fillColor, true)
            RenderUtils.drawOutline(newBox, outlineColor, true, 2)
