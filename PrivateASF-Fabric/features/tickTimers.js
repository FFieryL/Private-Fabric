...
const spawnPosition = register('packetReceived', (packet) => {
    try {
        ...
        // Fallback: If Reflection fails, use the toString method we verified earlier
...
register("chat", (message) => {
    ...
    if (newMSG.includes("[NPC] Mort: Here, I found this map when I first entered the dungeon.") || newMSG.includes("[NPC] Mort: Good luck.")) {
        spawnPos = null
